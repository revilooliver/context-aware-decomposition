    ...
    def nodes_on_wire(self, wire, only_ops=False):
        ...
        while more_nodes:
            ...
            try:
                ...
                pass
    def next_node_on_wire(self, wire, node, only_ops=False):
        """
        Finding the next node on the same wire
        """
        current_node = node
        return self._multi_graph.find_adjacent_node_by_edge(current_node._node_id, lambda x: wire == x)
